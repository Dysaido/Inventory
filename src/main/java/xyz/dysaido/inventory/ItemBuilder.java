...
public class ItemBuilder {
    ...
    public ItemBuilder displayName(String string) {
        ...
        meta.setDisplayName(ItemBuilder.colored(string));
    ...
    public ItemBuilder lore(String... lore) {
        ItemMeta meta = item.getItemMeta();
        meta.setLore(Arrays.stream(lore).map(ItemBuilder::colored).collect(Collectors.toList()));
        item.setItemMeta(meta);
        return this;
    }
    ...
    public ItemBuilder lore(Collection<String> lore) {
        ItemMeta meta = item.getItemMeta();
        meta.setLore(lore.stream().map(ItemBuilder::colored).collect(Collectors.toList()));
        item.setItemMeta(meta);
        return this;
    }
